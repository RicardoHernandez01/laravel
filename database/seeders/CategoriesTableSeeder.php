...
class CategoriesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $category1->description="Categoria basada en deportes como, futbolt, baloncesto, tenis";
        $category1->active=true;
        $category1->save();

        $category2 = new Category;
        $category2->name ="Accion";
        $category2->description="Categoria basada en en juegos repletos de accion";
